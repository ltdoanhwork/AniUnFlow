...
\begin{equation}
\label{eq:total_loss}
\mathcal{L} = \mathcal{L}_{\mathrm{unsup}} + \lambda_{\mathrm{sw}}\mathcal{L}_{\mathrm{segwarp}} + \lambda_{\mathrm{pr}}\mathcal{L}_{\mathrm{piece}} + \lambda_{\mathrm{ds}}\mathcal{L}_{\mathrm{dense-slot}} + \lambda_{\mathrm{cyc}}\mathcal{L}_{\mathrm{cycle}} + \lambda_{\mathrm{ord}}\mathcal{L}_{\mathrm{order}} + \lambda_{\mathrm{br}}\mathcal{L}_{\mathrm{boundary}} + \lambda_{\mathrm{dist}}\mathcal{L}_{\mathrm{distill}}.
\end{equation}
